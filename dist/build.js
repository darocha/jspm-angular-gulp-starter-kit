System.registerDynamic("github:angular-ui/angular-ui-router-bower@0.2.18/release/angular-ui-router.js", [], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
System.registerDynamic("github:angular-ui/angular-ui-router-bower@0.2.18.js", ["github:angular-ui/angular-ui-router-bower@0.2.18/release/angular-ui-router.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  module.exports = $__require('github:angular-ui/angular-ui-router-bower@0.2.18/release/angular-ui-router.js');
  return module.exports;
});

System.registerDynamic("github:angular/bower-angular@1.5.5/angular.js", [], false, function($__require, $__exports, $__module) {
...
System.registerDynamic("github:angular/bower-angular@1.5.5.js", ["github:angular/bower-angular@1.5.5/angular.js"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  module.exports = $__require('github:angular/bower-angular@1.5.5/angular.js');
  return module.exports;
});

System.register("src/cachedTemplates/templates.js", ["github:angular/bower-angular@1.5.5.js"], function (_export) {
  "use strict";

  var angular;
  return {
    setters: [function (_githubAngularBowerAngular155Js) {
      angular = _githubAngularBowerAngular155Js["default"];
    }],
    execute: function () {
      _export("default", angular.module("templates", []).run(["$templateCache", function ($templateCache) {
        $templateCache.put("app/home/home.tpl.html", "<h1>Welcome home</h1>\r\n<p>\r\n    {{appCtrl.welcomeMessgae}}\r\n</p>");
      }]));
    }
  };
});
System.register("src/routes.js", [], function (_export) {
  "use strict";
...
System.register('src/app/applicationController.js', [], function (_export) {
  'use strict';

  _export('default', applicationController);

  function applicationController($injector) {
...
System.register('src/main.js', ['github:angular/bower-angular@1.5.5.js', 'github:angular-ui/angular-ui-router-bower@0.2.18.js', 'src/cachedTemplates/templates.js', 'src/routes.js', 'src/app/applicationController.js'], function (_export) {
  'use strict';

  var angular, angularUiRouter, templates, routes, applicationController, app;
  return {
    setters: [function (_githubAngularBowerAngular155Js) {
      angular = _githubAngularBowerAngular155Js['default'];
    }, function (_githubAngularUiAngularUiRouterBower0218Js) {
      angularUiRouter = _githubAngularUiAngularUiRouterBower0218Js['default'];
    }, function (_srcCachedTemplatesTemplatesJs) {
      templates = _srcCachedTemplatesTemplatesJs['default'];
    }, function (_srcRoutesJs) {
      routes = _srcRoutesJs['default'];
    }, function (_srcAppApplicationControllerJs) {
      applicationController = _srcAppApplicationControllerJs['default'];
    }],
    execute: function () {
      app = angular.module('application', ['ui.router', 'templates']).config(["$stateProvider", "$urlRouterProvider", routes]).controller('applicationController', ['$injector', applicationController]);
